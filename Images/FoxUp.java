...
public class FoxUp {
    ...
    public static void paint() {
    	...
    	// HEAD
    	// black outline
    	drawVerticalLine(7, 10, 1, Color.black);
        drawHorizontalLine(5, 6, 9, Color.black);
        drawHorizontalLine(2, 3, 6, Color.black);
        drawVerticalLine(11, 14, 2, Color.black);
        ...
        drawHorizontalLine(9, 11, 9, Color.black);
        drawHorizontalLine(12, 14, 8, Color.black);
        drawVerticalLine(5, 7, 15, Color.black);
        putPixel(16, 4, Color.black);
        drawVerticalLine(5, 7, 17, Color.black);
        putPixel(18, 8, Color.black);
        putPixel(19, 9, Color.black);
        putPixel(17, 3, Color.black);
        putPixel(18, 4, Color.black);
        drawHorizontalLine(18, 19, 2, Color.black);
        drawVerticalLine(1, 2, 22, Color.black);
        drawVerticalLine(3, 9, 23, Color.black);
        drawHorizontalLine(19, 20, 1, Color.black);
        drawHorizontalLine(21, 22, 0, Color.black);
        ...
        drawHorizontalLine(12, 13, 22, Color.black);
        drawVerticalLine(17, 19, 20, Color.black);
        drawVerticalLine(16, 17, 21, Color.black);
        //black-nose
        putPixel(19, 23, Color.black);
        putPixel(20, 24, Color.black);
        putPixel(21, 23, Color.black); 
        // orange
        drawHorizontalLine(12, 18, 9, orange);
        drawVerticalLine(6, 15, 21, orange);
        drawVerticalLine(7, 10, 2, orange);
        drawVerticalLine(7, 8, 3, orange);
        ...
        drawHorizontalLine(7, 8, 9, orange);
        drawVerticalLine(13, 19, 7, orange);
        fillRect(8,10,12,11, orange);
        putPixel(9,21, orange);
        drawHorizontalLine(13, 19, 21, orange);
        drawHorizontalLine(14, 19, 22, orange);
        drawHorizontalLine(15, 17, 8, orange);
        drawVerticalLine(5, 7, 16, orange);
        putPixel(17, 4, orange);
        drawVerticalLine(3, 9, 22, orange);
        drawHorizontalLine(18, 21, 3, orange);
        drawHorizontalLine(20, 21, 2, orange);
        putPixel(21, 1, orange);
        ...
        drawHorizontalLine(9, 11, 22, Color.white);
        drawHorizontalLine(9, 18, 23, Color.white);
        ...
        drawHorizontalLine(3, 4, 9, Color.white);
        ...
        // white-right ear
        drawVerticalLine(5, 7, 18, Color.white);
        drawVerticalLine(4, 8, 19, Color.white);
        drawVerticalLine(3, 8, 20, Color.white);
        drawVerticalLine(4, 6, 21, Color.white);
       
        
        // TUMMY-ARMS
        
        // white
        fillRect(13, 26, 9, 3, Color.white);
        fillRect(16, 29, 2, 2, Color.white);
        drawHorizontalLine(19, 21, 25, orange);
        // orange
        putPixel(21, 24, orange);
        putPixel(22, 23, orange);
        
        fillRect(11, 31, 3, 3, orange);
        fillRect(12, 28, 3, 3, orange);
        fillRect(19, 26, 3, 5, orange);
        fillRect(18, 31, 3, 4, orange);
        drawHorizontalLine(20, 21, 28, orange);
        putPixel(13, 27, orange);
        putPixel(13, 26, orange);
        // black-outline
        drawVerticalLine(26, 27, 12, Color.black);
        drawVerticalLine(28, 30, 11, Color.black);
        drawVerticalLine(31, 33, 10, Color.black);
        drawHorizontalLine(11, 13, 34, Color.black);
        drawVerticalLine(29, 30, 15, Color.black);
        drawVerticalLine(31, 33, 14, Color.black);
        putPixel(16,31, Color.black);
        drawHorizontalLine(18, 20, 35, Color.black);
        drawVerticalLine(31, 34, 17, Color.black);
        drawVerticalLine(28, 30, 18, Color.black);
        drawVerticalLine(25, 27, 19, Color.black);
        
        drawVerticalLine(31, 34, 21, Color.black);
        ...
        try {       
            ImageIO.write(image, "png", new File("foxUp.png"));
