...
public class FoxUp3 {
    ...
    public static void paint() {
        ...
        drawVerticalLine(10, 11, 7, Color.black);
        putPixel(7, 23, Color.black);
        putPixel(7, 24, Color.black);
        drawHorizontalLine(8, 18, 25, Color.black);
        ...
        drawVerticalLine(10, 11, 22, orange);
        ...
        drawHorizontalLine(8, 19, 24, Color.white);
        ...
        // white-left ear
        putPixel(22, 6, Color.white);
        drawHorizontalLine(3, 4, 9, Color.white);
        drawHorizontalLine(4, 6, 10, Color.white);
        drawHorizontalLine(4, 6, 11, Color.white);
        drawHorizontalLine(3, 7, 12, Color.white);
        drawHorizontalLine(4, 6, 13, Color.white);
        putPixel(5, 14, Color.white);
        // white-right ear
        drawVerticalLine(6, 8, 18, Color.white);
        drawVerticalLine(5, 9, 19, Color.white);
        drawVerticalLine(4, 9, 20, Color.white);
        drawVerticalLine(5, 7, 21, Color.white);
        // black-eyes
        ...
        // black
        putPixel(8,12, Color.black);  
        putPixel(7,13, Color.black); 
        putPixel(18, 9, Color.black);
        putPixel(19, 10, Color.black);
        ...
        fillRect(12, 30, 3, 3, orange);
        fillRect(13, 27, 3, 3, orange);
        fillRect(19, 25, 4, 5, orange);
        fillRect(18, 30, 3, 4, orange);
        //drawHorizontalLine(20, 21, 28, orange);
        putPixel(14, 26, orange);
        // black-outline
        putPixel(13, 26, Color.black);
        drawVerticalLine(27, 29, 12, Color.black);
        drawVerticalLine(30, 32, 11, Color.black);
        drawHorizontalLine(12, 14, 33, Color.black);
        drawVerticalLine(28, 29, 16, Color.black);
        drawVerticalLine(30, 32, 15, Color.black);
        ...
        // orange
        drawHorizontalLine(24, 26, 11, orange);
        ...
        try {       
            ImageIO.write(image, "png", new File("foxUp3.png"));
